...
public class AccountTab extends JPanel implements ActionListener, KeyListener, MouseListener {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                for (int i = 0; i < rawData.length; i++) {
                    if (i == 3) {
                        rowData[i] = String.valueOf(countLine("src/data/library/" + name + "_return.txt"));
                    } else {
                        rowData[i] = rawData[i];
                    }
                }
